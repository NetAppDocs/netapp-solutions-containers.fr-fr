...
. Suivez les instructions link:https://docs.openshift.com/container-platform/4.7/installing/index.html["instructions d'installation"^] fournies par Red Hat pour déployer dans l’environnement de votre choix.
...
* link:os-on-bm.html["OpenShift sur Bare Metal"]
* link:os-on-openstack.html["OpenShift sur la plateforme Red Hat OpenStack"]
* link:os-on-rhv.html["OpenShift sur Red Hat Virtualization"]
* link:os-on-vmw.html["OpenShift sur VMware vSphere"]
