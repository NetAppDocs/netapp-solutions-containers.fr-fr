...
Trident, un outil de provisionnement et d'orchestration de stockage open source maintenu par NetApp, ainsi que son module complémentaire, NetApp Trident Protect, offre des solutions robustes pour l'orchestration et la gestion des données persistantes dans des environnements basés sur des conteneurs comme Red Hat OpenShift.
