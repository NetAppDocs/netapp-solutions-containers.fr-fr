...
. Installez l'extension F5 Application Services 3 pour permettre aux systèmes BIG-IP d'accepter les configurations au format JSON plutôt que les commandes impératives. Rendez-vous sur link:https://github.com/F5Networks/f5-appsvcs-extension/releases["Dépôt GitHub F5 AS3"^] et téléchargez le fichier RPM le plus récent.
