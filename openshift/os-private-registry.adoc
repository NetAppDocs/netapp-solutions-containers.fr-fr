...
[role="lead"]
Pour la plupart des déploiements de Red Hat OpenShift, l'utilisation d'un registre public comme https://quay.io["Quay.io"] ou https://hub.docker.com["DockerHub"] répond à la plupart des besoins des clients.  Cependant, il arrive parfois qu'un client souhaite héberger ses propres images privées ou personnalisées.
