...
Pour plus d'informations, visitez le link:https://www.openshift.com["Site Web Red Hat OpenShift"^].
...
Pour plus d'informations, visitez le link:https://www.netapp.com["site Web NetApp"^].
...
NetApp Trident est un orchestrateur de stockage open source et entièrement pris en charge pour les conteneurs et les distributions Kubernetes comme {k8s_distribution_name}. Pour plus d'informations, consultez le link:https://docs.netapp.com/us-en/trident/index.html["Documentation Trident"^].
